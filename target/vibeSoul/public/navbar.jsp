    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex ml-10 space-x-8">
                <a href="<%= request.getContextPath() %>/public/home.jsp" class="nav-link text-gray-700 hover:text-blue-600">Home</a>
                <a href="<%= request.getContextPath() %>/public/about.jsp" class="nav-link text-gray-700 hover:text-blue-600">About</a>
                <a href="<%= request.getContextPath() %>/public/contact.jsp" class="nav-link text-gray-700 hover:text-blue-600">Contact</a>
                <a href="<%= request.getContextPath() %>/public/login.jsp" class="nav-link text-gray-700 hover:text-blue-600">Login</a>
            </div>

            <!-- Desktop CTA -->
            <div class="hidden md:block">
                <button class="cta-button text-white px-6 py-2 rounded-full text-sm font-medium"
                        onclick="window.location.href='<%= request.getContextPath() %>/public/signup.jsp'">
                    Get Started
                </button>
            </div>
            ...
            <!-- Mobile Hamburger -->
            <div class="md:hidden">
                <button id="mobile-menu-button" class="flex flex-col space-y-1 focus:outline-none">
...
<div id="mobile-menu"
     class="fixed top-0 right-0 h-full w-64 bg-white shadow-xl z-40 transform translate-x-full transition-transform duration-300 md:hidden">
    <div class="pt-20 pb-6 px-6 space-y-6">
        <a href="<%= request.getContextPath() %>/public/home.jsp" class="block text-gray-700 hover:text-blue-600 text-lg font-medium border-b pb-2">Home</a>
        <a href="<%= request.getContextPath() %>/public/about.jsp" class="block text-gray-700 hover:text-blue-600 text-lg font-medium border-b pb-2">About</a>
        <a href="<%= request.getContextPath() %>/public/contact.jsp" class="block text-gray-700 hover:text-blue-600 text-lg font-medium border-b pb-2">Contact</a>
        <a href="<%= request.getContextPath() %>/public/login.jsp" class="block text-gray-700 hover:text-blue-600 text-lg font-medium border-b pb-2">Login</a>
        <button onclick="window.location.href='<%= request.getContextPath() %>/public/signup.jsp'"
                class="w-full bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-full font-medium mt-4">
            Get Started
        </button>
    </div>
</div>
