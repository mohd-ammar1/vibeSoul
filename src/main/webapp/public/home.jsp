...
<body class="bg-gray-50 text-gray-800">
    ...
    <section class="h-screen flex flex-col justify-center items-center text-center px-6 bg-gradient-to-r from-blue-500 to-indigo-600 text-white">
        <h1 class="text-5xl md:text-6xl font-extrabold mb-4 fade-in">Connect. Chat. Enjoy.</h1>
        <p class="text-lg md:text-xl mb-6 fade-in">Fast, secure and real-time messaging for everyone.</p>
